...
class ASLAlphabet(Dataset):
    ...
    def map_classes(self):
        self.map_classes_to_sign_writing_format(
            source_dir=f"{self.get_base_path()}/{self.name}/original/asl_alphabet_train/asl_alphabet_train",
            target_dir=f"{self.get_base_path()}/{self.name}/sw-classified/train",
        )

        self.map_classes_to_sign_writing_format_file_name_based(
            source_dir=f"{self.get_base_path()}/{self.name}/original/asl_alphabet_test/asl_alphabet_test",
